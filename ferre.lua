...
local function readIn( a )
    local desc, costol, impuesto, descuento, clave, u1, p1, u2, p2, u3, p3, fecha = encode( a[3] ), a[5], 1.0+a[6]/100.0, 1.0-a[7]/100.0, a[10], quot(a[11]), a[13], quot(a[14]), a[16], quot(a[17]), a[19], a[23]
